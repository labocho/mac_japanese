...
composed_or_normal_character_regexp = "/(" + make_pairs.map{|*, u| u}.select{|u| u.size > 8}.join("|") + "|.)/m"

open("#{ROOT_DIR}/lib/mac_japanese/composed_or_normal_character_regexp.rb", "w") do |f|
  f.puts <<-EOS
# This file was automatically generated by src/parse.rb.
# Cannot modify directly.
module MacJapanese
  COMPOSED_OR_NORMAL_CHARACTER_REGEXP = #{composed_or_normal_character_regexp}
end
EOS
end
